  ...
  <div class="container px-5 py-8 mx-auto">
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            <label for="status" class="leading-7 text-sm text-gray-600">販売状況</label><br>
            <input type="radio" id="status" name="status" value="1" v-model="form.status">未キャンセル
            <input type="radio" id="status" name="status" value="0" v-model="form.status">キャンセル済み
          </div>
        </div>
        <div class="p-2 w-full">
