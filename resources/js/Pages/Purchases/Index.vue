                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                <FlashMessage />
      <div class="flex pl-4 my-5 lg:w-2/3 w-full mx-auto">
        <div>
      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">販売状況</th>
        ...
        <tbody>
          <tr v-for="order in props.orders.data" :key="order.id">
            <!-- <td class="border-t-2 border-gray-200 px-4 py-3"> -->
                <!-- <Link class="text-blue-400" :href="route('customers.show', { customer:customer.id })">{{ customer.id }}
                </Link> -->
            <!-- </td> -->
            <td class="border-t-2 border-gray-200 px-4 py-3">
                <Link class="text-blue-400" :href="route('purchases.show', { purchase: order.id })">{{ order.id }}
                </Link>
            </td>
