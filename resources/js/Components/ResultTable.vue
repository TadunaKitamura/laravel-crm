...
<div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 w-full mt-4 mx-auto overflow-auto">
  ...
  <div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mt-4 mx-auto overflow-auto">
    <table class="table-auto w-full text-left whitespace-no-wrap">
      <thead>
        <tr>
      ...
      <tbody>
        <tr v-for="item in data.data" :key="item.date">
          ...
          <td class="border-t-2 border-gray-200 px-4 py-3">{{ item.totalPerGrou }}</td>
          <td class="border-t-2 border-gray-200 px-4 py-3">{{ item.totalRatio }}</td>
      </tr>
      </tbody>
    </table>
  </div>
  <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mt-4 mx-auto overflow-auto">
